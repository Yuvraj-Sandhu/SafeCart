...
const sampleRecalls = [
  {
    ...
    recallInitiationDate: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(), // 1 week ago
    ...
    source: 'FDA' as const,
    affectedStates: ['Nationwide'] // Nationwide recall
  },
  {
    id: 'sample-1',
    ...
    recallInitiationDate: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), // 2 days ago
    ...
    affectedStates: ['CA', 'TX', 'FL', 'NY', 'IL', 'WA', 'OR', 'NV', 'AZ'] // Multiple states (will show "and X more")
  },
  {
    id: 'sample-3',
    ...
    recallInitiationDate: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString(), // 1 month ago
    classification: 'Class I',
    ...
    source: 'USDA' as const,
    affectedStates: ['MI', 'OH', 'IN', 'WI'] // A few states
  }
];
